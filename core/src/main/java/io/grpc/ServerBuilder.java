...
public abstract class ServerBuilder<T extends ServerBuilder<T>> {
  ...
  /**
   * 设置是否允许客户端发送保持活动的HTTP/2 ping, 即使连接上没有发生服务调用
   *
   ...
   * @since 2019/2/25
   */
  public T permitKeepAliveWithoutCalls(boolean permitKeepAliveTime) {
    throw new UnsupportedOperationException();
  }


  /**
   * 指定允许客户端配置的最积极(最小)的保持活动时间。 服务器将尝试检测超过此速率的客户端，并在检测到时强制关闭连接。
   *
