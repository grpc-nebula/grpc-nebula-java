...
public class LongTimeHelloClient {
  ...
  public void greet(int id, String name) {
    ...
    HelloReply response;
    try {
        response = blockingStub.longTimeMethod(request);
  ...
  public static void main(String[] args) throws Exception {
    LongTimeHelloClient client = new LongTimeHelloClient();
