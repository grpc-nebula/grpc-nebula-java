...
import com.orientsec.grpc.common.RouteGuideUtil;
import com.orientsec.grpc.service.routeguide.Feature;
import com.orientsec.grpc.service.routeguide.Point;
import com.orientsec.grpc.service.routeguide.Rectangle;
import com.orientsec.grpc.service.routeguide.RouteGuideGrpc;
import com.orientsec.grpc.service.routeguide.RouteNote;
import com.orientsec.grpc.service.routeguide.RouteSummary;
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    try {
      for (int i = 0; i < LOOP_NUM; i++) {
        ...
        } else if ("2".equals(mode)) {// A server-to-client streaming RPC.
          // Looking for features between 40, -75 and 42, -73.
          client.listFeatures(400000000, -750000000, 420000000, -730000000);


        } else if ("3".equals(mode)) {// A client-to-server streaming RPC.
          // Record a few randomly selected points from the features file.
          client.recordRoute(features, 10);

        } else if ("4".equals(mode)) {// A Bidirectional streaming RPC.
