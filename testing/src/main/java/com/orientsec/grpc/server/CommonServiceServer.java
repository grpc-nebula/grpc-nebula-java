 ...
 * @since 2018/7/21
 */
public class CommonServiceServer extends GreeterServer{
  private static Logger logger = Logger.getLogger(CommonServiceServer.class.getName());

  private Server server;
  private int port = Constants.Port.COMMON_SERVICE_SERVER;
  ...
  public void start() throws IOException {
    ...
    logger.info("CommonServiceServer start...");
    ...
    Runtime.getRuntime().addShutdownHook(new Thread() {
      ...
      public void run() {
        ...
        CommonServiceServer.this.stop();
        System.err.println("*** CommonServiceServer shut down");
      }
    });
  }
  ...
  public void stop() {
    if (server != null) {
      logger.info("stop CommonServiceServer...");
      server.shutdown();
    }
  }
