...
public class ShortTimeHelloClient {
  private static final Logger logger = LoggerFactory.getLogger(ShortTimeHelloClient.class);

  private final ManagedChannel channel;
  private final GreeterGrpc.GreeterBlockingStub blockingStub;

  public ShortTimeHelloClient() {
  ...
  public static void main(String[] args) throws Exception {
    ShortTimeHelloClient client = new ShortTimeHelloClient();

    try {
      long count = 0;
      long interval = 10L;// 时间单位为毫秒
      int id;
